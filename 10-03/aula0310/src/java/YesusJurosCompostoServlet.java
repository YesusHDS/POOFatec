 ...
 * @author Yesus
 */
@WebServlet(urlPatterns = {"/yesus-juros-composto.json"})
public class YesusJurosCompostoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("c")!=null && request.getParameter("i")!=null && request.getParameter("t")!=null){
            ...
            obj.put("Capital","R$ "+c);
            obj.put("Taxa",i+"%");
            obj.put("Tempo",t+" dias");
            obj.put("Montante","R$ "+m);
            
        } else {
            obj.put("Error", "Insira os parâmetos corretamente!");
        }
